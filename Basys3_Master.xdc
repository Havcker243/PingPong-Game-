...
#7 segment display 
#The ports in the 7 segment display is used to connect to the hardware of the board #
...
##Buttons
#The buttons below are used to connect the ports in the hardware of the board #
